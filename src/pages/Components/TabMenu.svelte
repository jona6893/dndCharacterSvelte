<script>
  import Actions from "./tabMenu/Actions.svelte";
...
<div class="bg-gray-100 h-full shadow-md text- flex flex-col gap-4 p-4 col-span-3 rounded col-start-2 row-start-2">
